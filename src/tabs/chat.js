...
//         throw new Error("Failed to create modem context.");
//     }
//     if (Tinitus.EXPORTS.modem_context_init(modemContextPtr, modemProfilePtr) == -1) {
//         throw new Error("Failed to initialize modem context.");
//     }
//     let decoderPtr = Tinitus.EXPORTS.modem_context_get_decoder(modemContextPtr);
//     if (decoderPtr == -1) {
//         throw new Error("Failed to get decoder from modem context.");
//     }
